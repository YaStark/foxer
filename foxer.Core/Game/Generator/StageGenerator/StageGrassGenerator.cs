...
{
    public class StageGrassGenerator : StageGeneratorBase, IFloodGeneratorUser
    {
        private readonly FloodGenerator _floodGenerator;

        private const float RND_GRASS_PROBABILITY = 0.3f;

        public StageGrassGenerator()
        {
        ...
        {
            return new CellGrass(args.SourceCell);
        }
